<?php 
   ...
   // $staffcountm = $staffbmis->count_male_resident();
   // $staffcountf = $staffbmis->count_female_resident();
   // $staffcountfh = $staffbmis->count_head_resident();
   // $staffcountfm = $staffbmis->count_member_resident();
